...
source = ____(____={
    ...
    ____      : data.loc[1970].Country,
    ____      : (data.loc[1970].population / 20000000) + 2,
    ____      : data.loc[1970].region,
})
...
plot = figure(____='Gapminder Data for 1970', ____=____, ____=____,
              ____=(xmin, xmax), ____=(ymin, ymax))

# Add circle glyphs to the plot
plot.____(x=____, y=____, ____=____, source=____)
