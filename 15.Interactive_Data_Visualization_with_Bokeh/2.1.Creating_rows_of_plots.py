...
p1 = ____(____='fertility (children per woman)', ____='female_literacy (% population)')

# Add a circle glyph to p1
p1.circle(____, ____, ____)

# Create the second figure: p2
p2 = ____(____='population', ____='female_literacy (% population)')
